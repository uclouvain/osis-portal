...
urlpatterns = [
    ...
    url(r'^admission/application/diploma/save2/$', application.curriculum_save, name='curriculum'),
    url(r'^admission/application/curriculum/update/$', application.curriculum_update, name='curriculum_update'),
