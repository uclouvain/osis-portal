...
from base.models import academic_year as mdl_acad_year
from base.views import layout


CURRENT_ACADEMIC_YEAR = mdl_acad_year.current_academic_year()

@login_required
@permission_required('attestation.can_access_attestation', raise_exception=True)
def home(request):
    student = student_mdl.find_by_user(request.user)
    attestations_list_json = student_attestation.fetch_json_attestation_list(student.registration_id, CURRENT_ACADEMIC_YEAR)
