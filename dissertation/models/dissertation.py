...
from dissertation.models.dissertation_role import search_by_dissertation_and_role
...
class Dissertation(models.Model):
    ...
    def go_forward(self):
        ...
        if self.status == 'DRAFT' and next_status == 'DIR_SUBMIT':
            send_mail_to_teacher_new_dissert(search_by_dissertation_and_role(self, 'PROMOTEUR'))
