    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defend_periode', models.CharField(choices=[('UNDEFINED', 'undefined'), ('JANUARY', 'january'), ('JUNE', 'june'), ('SEPTEMBER', 'september')], default='UNDEFINED', max_length=12)),
                ('description', models.TextField(blank=True, null=True)),
                ('active', models.BooleanField(default=True)),
                ('creation_date', models.DateTimeField(auto_now_add=True)),
                ('modification_date', models.DateTimeField(auto_now=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.Student')),
                ('defend_year', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.AcademicYear')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PROMOTEUR', 'promotor'), ('CO_PROMOTEUR', 'copromotor'), ('READER', 'reader')], max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status_from', models.CharField(choices=[('DRAFT', 'draft'), ('DIR_SUBMIT', 'submitted_to_director'), ('DIR_OK', 'accepted_by_director'), ('DIR_KO', 'refused_by_director'), ('COM_SUBMIT', 'submitted_to_commission'), ('COM_OK', 'accepted_by_commission'), ('COM_KO', 'refused_by_commission'), ('EVA_SUBMIT', 'submitted_to_first_year_evaluation'), ('EVA_OK', 'accepted_by_first_year_evaluation'), ('EVA_KO', 'refused_by_first_year_evaluation'), ('TO_RECEIVE', 'to_be_received'), ('TO_DEFEND', 'to_be_defended'), ('DEFENDED', 'defended'), ('ENDED', 'ended'), ('ENDED_WIN', 'ended_win'), ('ENDED_LOS', 'ended_los')], default='DRAFT', max_length=12)),
                ('status_to', models.CharField(choices=[('DRAFT', 'draft'), ('DIR_SUBMIT', 'submitted_to_director'), ('DIR_OK', 'accepted_by_director'), ('DIR_KO', 'refused_by_director'), ('COM_SUBMIT', 'submitted_to_commission'), ('COM_OK', 'accepted_by_commission'), ('COM_KO', 'refused_by_commission'), ('EVA_SUBMIT', 'submitted_to_first_year_evaluation'), ('EVA_OK', 'accepted_by_first_year_evaluation'), ('EVA_KO', 'refused_by_first_year_evaluation'), ('TO_RECEIVE', 'to_be_received'), ('TO_DEFEND', 'to_be_defended'), ('DEFENDED', 'defended'), ('ENDED', 'ended'), ('ENDED_WIN', 'ended_win'), ('ENDED_LOS', 'ended_los')], default='DRAFT', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200)),
                ('type', models.CharField(choices=[('RDL', 'literature_review'), ('EDC', 'case_study')], default='RDL', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PROMOTEUR', 'promotor'), ('CO_PROMOTEUR', 'copromotor'), ('READER', 'reader')], default='PROMOTEUR', max_length=12)),
                ('adviser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dissertation.Adviser')),
