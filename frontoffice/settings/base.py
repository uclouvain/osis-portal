...
URL_SERVICE_DESK = os.environ.get('URL_SERVICE_DESK', '')
...
OSIS_ATTRIBUTION_SDK_HOST = os.environ.get("OSIS_ATTRIBUTION_SDK_HOST", "http://127.0.0.1:8000/api/v1/attribution")
...
# INSCRIPTION-EVALUATION-SDK-CONFIGURATION
OSIS_INSCRIPTION_EVALUATION_SDK_HOST = os.environ.get(
    "OSIS_INSCRIPTION_EVALUATION_SDK_HOST", "http://127.0.0.1:8000/api/v1/inscription_evaluation"
)
OSIS_INSCRIPTION_EVALUATION_SDK_API_KEY_PREFIX = os.environ.get("OSIS_INSCRIPTION_EVALUATION_SDK_API_KEY_PREFIX", "ESB")
...
PIKA_NEW = os.environ.get('PYKA_NEW', 'True').lower() == 'true'