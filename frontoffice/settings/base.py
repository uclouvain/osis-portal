...
URL_CONTINUING_EDUCATION_FILE_API = os.environ.get(
    ...
    "http://127.0.0.1:8000/api/v1/continuing_education/"
)

URL_COUNTRY_API = os.environ.get(
    "URL_COUNTRY_API",
    "http://127.0.0.1:8000/api/v1/reference/countries/"
)

URL_TRAINING_API = os.environ.get(
    "URL_TRAINING_API",
    "http://127.0.0.1:8000/api/v1/education_group/trainings/"
)

# BASE_API
URL_API_BASE_PERSON_ROLES = os.environ.get(
    "URL_API_BASE_PERSON_ROLES",
    ""
)
...
URL_AUTH_API = os.environ.get(
    "URL_AUTH_API",
    "http://127.0.0.1:8000/api/v1/base/person/%(global_id)s/roles"
)
# ATTRIBUTION-SDK-CONFIGURATION
OSIS_ATTRIBUTION_SDK_HOST = os.environ.get(
    "OSIS_ATTRIBUTION_SDK_HOST",
    "http://127.0.0.1:8000/api/v1/attribution"
)
...
OSIS_LEARNING_UNIT_ENROLLMENT_SDK_HOST = os.environ.get(
    "OSIS_LEARNING_UNIT_ENROLLMENT_SDK_HOST",
    "http://127.0.0.1:8000/api/v1/learning_unit_enrollment"
)
OSIS_LEARNING_UNIT_ENROLLMENT_SDK_API_KEY_PREFIX = os.environ.get(
    "OSIS_LEARNING_UNIT_ENROLLMENT_SDK_API_KEY_PREFIX",
    "ESB"
)

# LEARNING-UNIT-SDK-CONFIGURATION
OSIS_LEARNING_UNIT_SDK_HOST = os.environ.get(
    "OSIS_LEARNING_UNIT_SDK_HOST",
    "http://127.0.0.1:8000/api/v1/learning_unit"
)
OSIS_LEARNING_UNIT_SDK_API_KEY_PREFIX = os.environ.get(
    "OSIS_LEARNING_UNIT_SDK_API_KEY_PREFIX",
    "ESB"
)

# REFERENCE-SDK-CONFIGURATION
OSIS_REFERENCE_SDK_HOST = os.environ.get(
    "OSIS_REFERENCE_SDK_HOST",
    "http://127.0.0.1:8000/api/v1/reference"
)
...
OSIS_INTERNSHIP_SDK_HOST = os.environ.get(
    'OSIS_INTERNSHIP_SDK_HOST',
    "http://127.0.0.1:8000/api/v1/internship"
)
...
OSIS_OFFER_ENROLLMENT_SDK_HOST = os.environ.get(
    "OSIS_OFFER_ENROLLMENT_SDK_HOST",
    "http://127.0.0.1:8000/api/v1/offer_enrollment"
)
...
OSIS_ORGANISATION_SDK_HOST = os.environ.get("OSIS_ORGANISATION_SDK_HOST", "http://127.0.0.1:8000/api/v1/organisation")
...
OSIS_EXAM_ENROLLMENT_SDK_HOST = os.environ.get(
    "OSIS_EXAM_ENROLLMENT_SDK_HOST",
    "http://127.0.0.1:8000/api/v1/exam_enrollment"
)
