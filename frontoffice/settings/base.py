...
TIME_TABLE_URL = ATTRIBUTION_CONFIG.get('TIME_TABLE_URL')
TIME_TABLE_NUMBER = ATTRIBUTION_CONFIG.get('TIME_TABLE_NUMBER')
CATALOG_URL = ATTRIBUTION_CONFIG.get('CATALOG_URL')
