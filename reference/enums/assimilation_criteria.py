...
ASSIMILATION_CRITERIA_CHOICES = (
    (CRITERIA_1, _(CRITERIA_1), 1),
    (CRITERIA_2, _(CRITERIA_2), 2),
    (CRITERIA_3, _(CRITERIA_3), 3),
    (CRITERIA_4, _(CRITERIA_4), 4),
    (CRITERIA_5, _(CRITERIA_5), 5),
    (CRITERIA_6, _(CRITERIA_6), 6),
    (CRITERIA_7, _(CRITERIA_7), 7),
)
